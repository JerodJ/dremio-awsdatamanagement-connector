...
3. Download and install the [AWS Data Management JDBC Driver from CData](https://www.cdata.com/drivers/awsmanagement/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
